...
2-Crie um programa em linguagem C que crie uma matriz de 10 x 3 
-Armazene a nota P1, P2 e MEDIA nas respectivas colunas
-Crie uma função passando a matriz como parâmetro para identificar a maiorNotaP1, 
a maiorNotaP2 e a maiorMedia e mediaSala
